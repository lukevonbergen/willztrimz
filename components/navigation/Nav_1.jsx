    ...
    <header className="w-full py-6 px-6 md:px-12 border-b border-gray-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-8 text-sm font-medium text-gray-700">
          <a href="#features" className="hover:text-black transition">Pricing</a>
          <a href="#pricing" className="hover:text-black transition">Gallery</a>
          <a href="#examples" className="hover:text-black transition">About</a>
        </nav>
